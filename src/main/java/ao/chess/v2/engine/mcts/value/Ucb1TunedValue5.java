...
public class Ucb1TunedValue5 implements MctsValue<Ucb1TunedValue5>
{
    //--------------------------------------------------------------------
    ...
    public static class Factory
            implements MctsValue.Factory<Ucb1TunedValue5> {
        @Override public Ucb1TunedValue5 newValue() {
            return new Ucb1TunedValue5();
        }
    }
    ...
    public static class VisitSelector
            implements MctsSelector<Ucb1TunedValue5> {
        @Override public int compare(
                Ucb1TunedValue5 a, Ucb1TunedValue5 b) {
            return a.visits - b.visits;
        }

        @Override
        public double asDouble(Ucb1TunedValue5 value) {
            return value.visits;
        }
    }
