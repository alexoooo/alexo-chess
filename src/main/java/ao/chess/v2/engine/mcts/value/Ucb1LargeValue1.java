...
public class Ucb1LargeValue1 implements MctsValue<Ucb1LargeValue1>
{
    //--------------------------------------------------------------------
    ...
    public static class Factory
            implements MctsValue.Factory<Ucb1LargeValue1> {
        @Override public Ucb1LargeValue1 newValue() {
            return new Ucb1LargeValue1();
        }
    }
    ...
    public double confidenceBound(
            int parentChoices,
            Ucb1LargeValue1 withRespectToParent) {
    ...
    public static class VisitSelector
            implements MctsSelector<Ucb1LargeValue1> {
        @Override public int compare(Ucb1LargeValue1 a, Ucb1LargeValue1 b) {
            return a.visits - b.visits;
        }

        @Override
        public double asDouble(Ucb1LargeValue1 value) {
            return value.visits;
        }
    }
