 ...
 * Time: 10:54:23 PM
 */
public class Ucb1Value1 implements MctsValue<Ucb1Value1>
{
    //--------------------------------------------------------------------
    ...
    public static class Factory
            implements MctsValue.Factory<Ucb1Value1> {
        @Override public Ucb1Value1 newValue() {
            return new Ucb1Value1();
        }
    }
    ...
    public double confidenceBound(
            int parentChoices,
            Ucb1Value1 withRespectToParent) {
    ...
    public static class VisitSelector
            implements MctsSelector<Ucb1Value1> {
        @Override public int compare(Ucb1Value1 a, Ucb1Value1 b) {
            return a.visits - b.visits;
        }

        @Override
        public double asDouble(Ucb1Value1 value) {
            return value.visits;
        }
    }
