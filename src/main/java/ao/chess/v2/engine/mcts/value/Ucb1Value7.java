 ...
 * Time: 10:54:23 PM
 */
public class Ucb1Value7 implements MctsValue<Ucb1Value7>
{
    //--------------------------------------------------------------------
    ...
    public static class Factory
            implements MctsValue.Factory<Ucb1Value7> {
        @Override public Ucb1Value7 newValue() {
            return new Ucb1Value7();
        }
    }
    ...
    public double confidenceBound(
            Ucb1Value7 transpositionValue,
            Ucb1Value7 withRespectToParent) {
    ...
    public static class VisitSelector
            implements MctsSelector<Ucb1Value7> {
        @Override public int compare(Ucb1Value7 a, Ucb1Value7 b) {
            return a.visits - b.visits;
        }

        @Override
        public double asDouble(Ucb1Value7 value) {
            return value.visits;
        }
    }
