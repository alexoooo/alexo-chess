 ...
 * Time: 10:54:23 PM
 */
public class Ucb1Value5 implements MctsValue<Ucb1Value5>
{
    //--------------------------------------------------------------------
    ...
    public static class Factory
            implements MctsValue.Factory<Ucb1Value5> {
        @Override public Ucb1Value5 newValue() {
            return new Ucb1Value5();
        }
    }
    ...
    public static class VisitSelector
            implements MctsSelector<Ucb1Value5> {
        @Override public int compare(Ucb1Value5 a, Ucb1Value5 b) {
            return a.visits - b.visits;
        }

        @Override
        public double asDouble(Ucb1Value5 value) {
            return value.visits;
        }
    }
